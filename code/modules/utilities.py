...
def read_static_image(image_path: str) -> Any:
    if not image_path:
        return None

    # Avoid OpenCV warnings on Windows when path contains non-ASCII chars.
    use_imdecode_first = False
    try:
        image_path.encode('ascii')
    except UnicodeEncodeError:
        use_imdecode_first = True
