...
live_width = 640  # Live camera output width
live_height = 640  # Live camera output height
max_memory = None
...
opacity: float = 1.0
sharpness: float = 0.0
face_enhancer_intensity: float = 1.0
enable_interpolation: bool = True
interpolation_weight: float = 0.2
